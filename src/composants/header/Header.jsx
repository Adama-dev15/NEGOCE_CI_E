        ...
        <div className="header_navigation">
            ...
            <div className="navigation">
                <div className="article">
                    <div className='name'>téléphones <i className="fas fa-search"></i></div>
                ...
                <div className="article">
                    <div className='name'>tablettes <i className="fas fa-search"></i></div>
                    <div className='article_element'>
                        <ul>
                            <li><a href="#">element_1</a></li>
                            <li><a href="#">element_2</a></li>
                ...
                <div className="article">
                    <div className='name'>informatique <i className="fas fa-search"></i></div>
                    <div className='article_element'>
                        <ul>
                            <li><a href="#">element_1</a></li>
                            <li><a href="#">element_2</a></li>
                ...
                <div className="article">
                    <div className='name'>electronique <i className="fas fa-search"></i></div>
                    <div className='article_element'>
                        <ul>
                            <li><a href="#">element_1</a></li>
                            <li><a href="#">element_2</a></li>
                ...
                <div className="article">
                    <div className='name'>modes <i className="fas fa-search"></i></div>
                    <div className='article_element'>
                        <ul>
                            <li><a href="#">element_1</a></li>
                            <li><a href="#">element_2</a></li>
                ...
                <div className="article">
                    <div className='name'>accesssoires <i className="fas fa-search"></i></div>
                    <div className='article_element'>
                        <ul>
                            <li><a href="#">element_1</a></li>
                            <li><a href="#">element_2</a></li>
